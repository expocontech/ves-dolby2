...
import PasteventsDesign from "./PasteventsDesign"

class PasteventsMain extends React.Component {
  state = {
    value: ""
  }
    ...
    return (
      <Row>
        <Col sm="12">
          <Card className="mt-1">
            <CardBody className="knowledge-base-bg">
              <h1 className="white">Past Events</h1>
        ...
        <Col sm="12" style={{paddingLeft:"30px",paddingRight:"30px"}}>
          <PasteventsDesign value={this.state.value} />
        </Col>
      </Row>
    )
  }
}
export default PasteventsMain
