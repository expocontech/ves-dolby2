...
import dummy from "../../../assets/img/pages/committee/dummy.jpg";
...
import { FaQuestionCircle, FaFileDownload, FaWpforms } from "react-icons/fa";
// import { FaWpforms,  FaSignal, FaCertificate, FaRegQuestionCircle, FaTicketAlt, FaAward, FaFileDownload } from "react-icons/fa"
...
const UserDropdown = (props) => {
  ...
  return (
    <DropdownMenu right style={{ width: "max-content" }}>
      ...
      <DropdownItem tag="a" href="/pages/delegatelist">
        <Icon.User size={14} className="mr-50" />
        <span className="align-middle">Delegate</span>
      </DropdownItem>
      {/*  <DropdownItem
        tag="a" href="/pages/liveview">
        <Icon.Video size={14} className="mr-50" />
        <span className="align-middle">Live View</span>
      </DropdownItem>
      <DropdownItem
        tag="a" href="/pages/pastevents">
        <Icon.Mic size={14} className="mr-50" />
        <span className="align-middle">Past Events</span>
      </DropdownItem>
      <DropdownItem
        tag="a" href="/pages/upcomingevents">
        <Icon.Mic size={14} className="mr-50" />
        <span className="align-middle">Upcoming Events</span>
      </DropdownItem>
      <DropdownItem
        tag="a" href="/pages/eposter">

        <FaFileDownload size={14} className="mr-50"/>
        <span className="align-middle">Eposter</span>
      </DropdownItem>
      <DropdownItem
        tag="a" href="/pages/sponsor">
    ...
    return (
      <ul className="nav navbar-nav navbar-nav-user float-right">
        ...
        <UncontrolledDropdown
          ...
          className="dropdown-notification nav-item"
        >
          <Link tag="a" className="nav-link nav-link-label" to="/pages/faq">
            <GoReport size={21} />
          </Link>
            </UncontrolledDropdown>*/}
        {/* <UncontrolledDropdown
        ...
        <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            <div className="user-nav d-sm-flex d-none">
              ...
              <span
                className="user-status text-bold-400"
            ...
            <span data-tour="user">
              <Button color="primary" className="btn-icon round">
